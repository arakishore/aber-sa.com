...
if ($warning) {
    ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/editdistrict/'.$stateid.'/'.$records['id']) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="name">Name(Arabic) :<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <a href="<?php echo site_url($controller."/addDistrict/".$stateid); ?>"><button type="button" class="btn btn-light  ml-2">Cancel</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
