...
//AND status_flag='Active'
    ...
    public function allRequest($params, $returnformat = "JSON")
    {
        ...
        if ($driver_status == "ongoing") {
            $sql_cond_dri_status = "  and   r.is_trip_started='1'";
        } else if ($driver_status == "completed") {
            $sql_cond_dri_status = "  and   r.is_trip_completed='1' ";
    ...
    public function doRequestStatusActionByDriver($params, $returnformat = "JSON")
    {
        ...
        if ($query->num_rows()> 0) {
            ...
            if ($action_flag == "Dispatch") {
                $request_status = "Scheduled";
                $request_sub_status = "Dispatch";
            }
            if ($action_flag == "Pickup") {
                $request_status = "Scheduled";
                $request_sub_status = "Pickup";
            }
            if ($action_flag == "Delivered") {
