...
?>                                
                                ...
                                <div class="fb-left-bar-profile">
                                    ...
                                    <a class="fb-left-bar-edit-profile" href="<?php echo site_url('serviceprovider/edit_profile')?>">Edit profile</a>
                                </div>
                            </div>
                            <ul class="fb-left-bar-menus">
                                ...
                                <li><a href="<?php echo site_url('serviceprovider/change_password')?>" <?php if(isset($l_s_act) && $l_s_act==7){ echo 'class="active"';}?>>Change Password<span><i class="fal fa-angle-right"></i> </span></a></li>                                
                                <li><a href="<?php echo site_url('serviceprovider/log_out')?>">Log Out</a></li>
                            </ul>
                        </div>
                    </div>