...
class Apiuser extends CI_Controller
{
	...
	public function changePassword()
    {
        ...
        if (isset($data_json['frm_mode']) && $data_json['frm_mode'] == 'changePassword') {
            ...
            if ($oldpassword == '') {
                 $errorData[] = "Please enter old password";
			}
 ...
 */
        ...
        if (isset($data_json['frm_mode']) && $data_json['frm_mode'] == 'doAddAddress') {
            ...
            if ($district_id == '') {
                $errorData[] = "Please select  district";
            }
            if ($postcode == '') {
	...
	public function deleteAddress()
    {
       ...
       /*  if (debug == 1) {
		...
		if (isset($data_json['frm_mode']) && $data_json['frm_mode'] == 'deleteAddress') {
			...
			if (sizeof($errorData) <= 0) {
                $returnData = $this->services->deleteAddress($data_json,0, 'ARRAY');
	...
	// method=form-data
    public function setProfilePic($returnformat = "json")
    {
       ...
       /*  if(debug==1){
        ...
        if (isset($_POST['frm_mode']) && $_POST['frm_mode'] == 'setProfilePic') {
            ...
            if ($error == "") {
                ...
                $where_edt = "user_id = '" . $user_id . "' and status='Active' ";
