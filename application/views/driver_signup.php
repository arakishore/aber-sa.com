                    ...
                    <div class="fb-dashbord">
                        ...
                        <div class="login-form-main-section signup-form-main-section">
                            <form name="frm-edit" id="frm-edit"
                                action="<?php echo site_url($controller.'/driver_signup') ?>" method="post"
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first_name" name="first_name"
                                                    value="<?php echo isset($_POST['first_name'])?$this->common->getDbValue($_POST['first_name']):''; ?>">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last_name" id="last_name"
                                                    value="<?php echo isset($_POST['last_name'])?$this->common->getDbValue($_POST['last_name']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" id="email"
                                                    value="<?php echo isset($_POST['email'])?$this->common->getDbValue($_POST['email']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" id="mobile"
                                                    value="<?php echo isset($_POST['mobile'])?$this->common->getDbValue($_POST['mobile']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address_name" id="address_name"
                                                    value="<?php echo isset($_POST['address_name'])?$this->common->getDbValue($_POST['address_name']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city_id" id="city_id"
                                                    value="<?php echo isset($_POST['city_id'])?$this->common->getDbValue($_POST['city_id']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="state_id" id="state_id"
                                                    value="<?php echo isset($_POST['state_id'])?$this->common->getDbValue($_POST['state_id']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="postcode" id="postcode"
                                                    value="<?php echo isset($_POST['postcode'])?$this->common->getDbValue($_POST['postcode']):''; ?>">
                                                <!--<div class="error-red">This field is required</div>-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <label class="input-group-btn my-0">
                                                    <span class="btn btn-large btn-outline-primary rounded-0"
                                                        id="browse">
                                                        Browse&hellip;
