                                ...
                                <div class="card-content">
                                    <div class="row row-group">
                                        <div class="col-12 col-lg-6 col-xl-6 border-light">
                                            <div class="card-body">
                                              <h5 class="mb-0"><?php echo $total_orders?> <span class="float-right"><i class="fa fa-shopping-cart"></i></span></h5>
                                        ...
                                        <div class="col-12 col-lg-6 col-xl-6 border-light">
                                            <div class="card-body">
                                              <h5 class=" mb-0"><?php echo $total_revenue['total_reve']?> <span class="float-right"><i class="fa fa-usd"></i></span></h5>
                                                <div class="progress my-3" style="height:3px;">
                                                   <div class="progress-bar" style="width:55%"></div>
                                                </div>
