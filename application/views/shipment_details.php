                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="shipment-listing-info">
                                ...
                                <div class="shipment-listing-main">
                                    ...
                                    <div class="shipment-listing-contnet">
                                        <?php echo $this->common->getDateFormat($requests['insert_date'], 'd-M-Y h:i');; ?> CST
                                    </div>
                                </div>
                                <div class="shipment-listing-main">
                                    <div class="shipment-listing-head">
                                    ...
                                    <div class="shipment-listing-contnet">
                                        <?php echo $this->common->getDbValue($requests['expected_travelling_time']); ?>  <br> <?php echo $this->common->getDateFormat($requests['request_quote_expiry'], 'd-M-Y h:i');; ?> CST
                                    </div>
                                </div>
                                <div class="shipment-listing-main">
                                    <div class="shipment-listing-head">
