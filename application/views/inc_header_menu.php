<header class="wow fadeInDown">
        <div class="trans-header-main">
            ...
            <div class="trans-header-join-menu">
                <ul>
                    <li><a href="<?php echo site_url('signup')?>">Join</a> &nbsp;&nbsp; | &nbsp;&nbsp;</li>
                    <li><a href="<?php echo site_url('login')?>"><img src="<?php echo base_url();?>assets/images/menu-user-icon.png" alt="menu-user-icon" /></a></li>
                </ul>
            </div>
            <div class="trans-header-menu-section">                    
                ...
                <ul>
                    ...
                    <li><a href="<?php echo site_url('serviceprovider/my_shipment')?>" class="<?php if(isset($act_id) && $act_id==3){ echo 'active';}?>">My Shipment</a></li>
                    <li><a href="<?php echo site_url('serviceprovider')?>" class="<?php if(isset($act_id) && $act_id==4){ echo 'active';}?>">Get Started</a></li>
                </ul>
            </div>                
