 ...
 *
 * @license		MIT License -
 * @author		kishore, swami
 * @link		http://www.webtreeindia.com
 * @docu		http://todo :)
 * @email		swamiwebservices@gmail.com
 *
 * @file		Kishoreimagelib.php
 * @version		1.1.6
 * @date		2014 Feb 5
 *
...
class Kishoreimagelib
{
	...
	//----------------------------------------------------------------------------------------------------------
	// verification util to see if you can use Kishoreimagelib
	//----------------------------------------------------------------------------------------------------------
	{
		// is gd loaded?
	...
	//----------------------------------------------------------------------------------------------------------
	{
		...
		if(!is_resource($this->temp_image))
		{
			$this->set_error('Unable to create temp image sized ');
			return $this;
		}
...
/* End of file Kishoreimagelib.php */
/* Location: /application/libraries/Kishoreimagelib.php */