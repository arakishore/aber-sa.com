...
if ($warning) {
    ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/editemailtemplate/'.$email_id) ?>" method="post" enctype="multipart/form-data"  >
                                <input type="hidden" name="mode" id="mode" value="submitform">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="email_subject">Subject :<span class="text-danger">*</span></label>
                                    <div class="col-lg-9"><input type="text" class="form-control " id="email_subject" name="email_subject" placeholder="email subject" value="<?php echo isset($records['email_subject'])?$this->common->getDbValue($records['email_subject']):''; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <a href="<?php echo site_url($controller.'/emailtemplate'); ?>"><button type="button" class="btn btn-light  ml-2">Cancel</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $("#frm-edit").submit(function(e) {
                ...
                if (!$("#email_description").val()) {
                    isError = true;
                    //$("#error_name").show()
                    $("#email_description").addClass("border-danger");
