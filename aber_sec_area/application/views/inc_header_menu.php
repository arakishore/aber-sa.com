<header class="wow fadeInDown">
        <div class="trans-header-main">
            ...
            <div class="trans-header-join-menu">
                <ul>
                    <li><a href="<?php echo site_url('login')?>">Join</a> &nbsp;&nbsp; | &nbsp;&nbsp;</li>
                    <li><a href="<?php echo site_url('signup')?>"><img src="<?php echo base_url();?>assets/images/menu-user-icon.png" alt="menu-user-icon" /></a></li>
                </ul>
            </div>
