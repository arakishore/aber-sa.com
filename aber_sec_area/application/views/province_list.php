                    ...
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="header-elements d-none">
                            <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($controller . "/addProvince"); ?>" class="breadcrumb-elements-item">
                        ...
                        <table width="100%" class="table table-hover datatable-responsive">
                            <thead>
                                <tr class="bg-blue ">
                                    ...
                                    <th width="25%" align="left">Name (Arabic)</th>
...
if ($status == "Inactive") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td align="center" class="text-center">
                                        ...
                                        <a href="<?php echo site_url($controller . '/addDistrict/' . $value['id']) ?>" class="list-icons-item text-primary-600 " data-popup="tooltip" title="" data-original-title="Add cities"><i class="icon-add"></i></a> |    <a href="<?php echo site_url($controller . '/editprovince/' . $value['id']) ?>" class="list-icons-item text-primary-600 ml-2" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a>   
