            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($this->ctrl_name.'/edit_category/'.$id) ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="category_id">Parent category :</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="name_title">Name (Arabic):<span class="text-danger">*</span></label>
                                    <div class="col-lg-9"><input type="text" class="form-control  alhanumeric" id="name" name="name" placeholder="Name" value="<?php echo isset($records['name'])?$this->common->getDbValue($records['name']):''; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9"><input type="text" class="form-control  alhanumeric" id="name_en" name="name_en" placeholder="Name" value="<?php echo isset($records['name_en'])?$this->common->getDbValue($records['name_en']):''; ?>">
                                        <!-- <div id="basic-error" class="validation-invalid-label" for="basic">This field is required.</div> -->
                                    </div>
                                </div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Description (Arabic):<span class="text-danger">*</span></label>
									<div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="sort_order">Sort order :<span class="text-danger">*</span></label>
                                    <div class="col-lg-9"><input type="text" class="form-control  numbersOnly" id="sort_order" name="sort_order" placeholder="sort order" value="<?php echo isset($records['sort_order'])?$this->common->getDbValue($records['sort_order']):''; ?>">
