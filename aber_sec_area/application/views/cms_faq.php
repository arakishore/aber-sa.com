                ...
                <div class="page-header page-header-light">
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($controller . "/faqadd"); ?>" class="breadcrumb-elements-item">
        ...
        ?>
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            ...
                                            <a href="<?php echo site_url($this->ctrl_name.'/delete_faq/'. $value['id'])?>" class="list-icons-item text-danger-600" title="Delete" onClick="return confirm('Are you sure want to delete this record?');"><i class="icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php }?>
